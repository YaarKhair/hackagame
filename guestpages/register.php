...
<?php
	...
	$result = mysqli_query($link, "INSERT INTO hacker (alias, email, password, salt, activationcode, started, last_click, ip, real_ip, country, fbi_serverip, fbi_serverpass, donator_till, topics, support_tickets, referral_id) VALUES ('$alias', '$email', '$salted_pass', '$salt', '$code', '$now', '$now', '".randomip()."', '$ip', '$country', '".randomip()."', '".createrandomPassword()."', '$premium_date', $daily_topics, $daily_tickets, $referral_id)");
